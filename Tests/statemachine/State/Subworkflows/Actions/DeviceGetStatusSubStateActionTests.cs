...
namespace Devices.Core.State.SubWorkflows.Actions.Tests
{
    ...
    {
        readonly DeviceGetStatusSubStateAction subject;

        readonly Mock<IDeviceSubStateController> mockSubController;
        // Mock<ILoggingServiceClient> mockLoggingClient;
        ...
        public DeviceGetStatusSubStateActionTests()
        {
            ...
            //.SetupGet(e => e.LoggingClient).Returns(mockLoggingClient.Object);
            ...
            subject = new DeviceGetStatusSubStateAction(mockSubController.Object);
        ...
        [Fact]
        public void SubWorkflowStateType_Should_Equal_GetStatus()
            => Assert.Equal(DeviceSubWorkflowState.GetStatus, subject.WorkflowStateType);
        ...
        [Fact]
        public void ComEventReceived_ShouldLogEventAndPortNumber_WhenCalled()
        {
        ...
        public async void DoWork_ShouldForceCompletionWithCancelation__WhenTestingGetStatus(string exception, string userEvent, DeviceEvent deviceEvent)
        {
            LinkActionRequest linkActionRequest = linkRequest.Actions.First();
            ...
            linkActionRequest.DeviceRequest = new LinkDeviceRequest()
            {
                //LinkObjects = new LinkDeviceRequestIPA5Object()
                //{
                //    DALResponseData = new LinkDeviceActionResponse
                //    {
                //        Errors = new List<LinkErrorValue>
                //        {
                //            new LinkErrorValue
            ...
            fakeDeviceOne.Setup(e => e.GetStatus(It.IsAny<LinkRequest>())).Returns(linkRequest);
            ...
            //mockLoggingClient.Verify(e => e.LogErrorAsync(string.Format("Unable to obtain device status - '{0}'.", userEvent),
        ...
        public async void DoWork_ShouldFailRequest_When_TimeoutPolicyReturnsFailureForMultipleDevices()
        {
            ...
            //mockLoggingClient.Verify(e => e.LogErrorAsync(It.IsAny<string>(), It.IsAny<Dictionary<string, object>>()), Times.Exactly(2));
        ...
        public async void DoWork_ShouldForceCompletionWithCancelation__WhenTestingGetStatusForMultipleDevices(string exception, string userEvent, DeviceEvent deviceEvent)
        {
            ...
            fakeDeviceTwo.Setup(e => e.DeviceInformation).Returns(deviceInformation);
            fakeDeviceOne.Setup(e => e.GetStatus(It.IsAny<LinkRequest>())).Returns(linkRequest);
            fakeDeviceTwo.Setup(e => e.GetStatus(It.IsAny<LinkRequest>())).Returns(linkRequest);
