...
namespace HMACHasher
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //string decriptedPrimaryPANSalt = Hasher.HMACHasher.DecryptHMAC(Encoding.ASCII.GetString(HMACValidator.MACPrimaryPANSalt), HMACValidator.MACSecondaryKeyHASH);
            ...
            //string decriptedVSS06Hash = Hasher.HMACHasher.DecryptHMAC(Encoding.ASCII.GetString(HMACValidator.MACPrimaryHASHSalt), HMACValidator.MACSecondaryKeyHASH);
            ...
            string decriptedVSS07Hash = Hasher.HMACHasher.DecryptHMAC(Encoding.ASCII.GetString(HMACValidator.MACSecondaryHASHSalt), HMACValidator.MACPrimaryKeyHASH);
        ...
        {
            // *** HOW TO CONSTRUCT MACPrimaryPANSalt ***
            string encryptedHashText = Hasher.HMACHasher.EncryptHMAC(PANSecret, HMACValidator.MACSecondaryKeyHASH);
        ...
        static void Generate_MACPrimaryHASHSalt()
        {
            ...
            // *** HOW TO CONSTRUCT MACPrimaryHASHSalt ***
            string encryptedHashText = Hasher.HMACHasher.EncryptHMAC(expectedVSSKey06, HMACValidator.MACSecondaryKeyHASH);
            byte[] encryptedHashBytes = Encoding.ASCII.GetBytes(encryptedHashText);
            // TAKE THE VALUE IN THE DEBUGGER AND REPLACE IT IN HMACValidator: 
        ...
        static void Generate_MACPrimaryKeyHASH()
        {
            ...
            string encryptedHashText = Hasher.HMACHasher.EncryptHMAC(expectedVSSKey07, HMACValidator.MACPrimaryKeyHASH);
